package lk.ijse.eca.borrowingservice.handler;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleBorrowingNotFound(
            BorrowingNotFoundException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ProblemDetail> handleDuplicateBorrowing(
            DuplicateBorrowingException ex, HttpServletRequest request) {
        log.warn("Duplicate borrowing: {}", ex.getMessage());
        ProblemDetail problem = buildProblemDetail(
                HttpStatus.CONFLICT,
                "Duplicate Borrowing",
                ex.getMessage(),
